...
<head>
    ...
    <title>Uneix-te - BCN SOLIDÀRIA</title>
...
<header class="site-header">
    <div class="header-container">
        ...
        <nav class="main-nav">
            ...
            <a href="/pages/login.php" class="btn-join">Inicia Sessió</a>
        </nav>
    </div>
</header>
...
<main class="auth-container">
    <div class="auth-card">
        ...
        <h1 class="auth-title">Crea el teu compte</h1>
        <p class="auth-subtitle">Uneix-te a la xarxa solidària de Barcelona.</p>

        <!-- FORMULARIO -->
        <form class="auth-form" action="../guardar_usuario.php" method="POST">
    <div class="form-group">
        ...
        <div class="input-wrapper">
            ...
            <!-- 🔥 AÑADIDO name -->
            <input type="text" id="name" name="nombre" placeholder="Jordi Vila" required>
        </div>
    </div>
